...
const IntroAutocad = () => {
  return (
    <div className="text-[#1A1A2E] p-6 bg-white">
      ...
      <p className="leading-relaxed mb-2">در بخش اول این دوره، دانشجویان با محیط کاربری AutoCAD و ابزارهای پایه‌ای آن آشنا می‌شوند. آن‌ها می‌آموزند که چگونه از ابزارهای ترسیم و ویرایش برای ایجاد نقشه‌های دقیق دو بعدی استفاده کنند. مباحثی مانند ایجاد و ویرایش خطوط، اشکال هندسی، متن و جداول در این بخش تدریس می‌شود. همچنین، دانشجویان با اصول لایه‌بندی و مدیریت لایه‌ها، اندازه‌گذاری و استفاده از بلوک‌ها آشنا می‌شوند که به آن‌ها کمک می‌کند تا نقشه‌های حرفه‌ای‌تری را تهیه کنند.</p>
