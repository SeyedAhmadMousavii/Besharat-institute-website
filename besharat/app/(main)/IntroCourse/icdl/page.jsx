        ...
        <div className="p-4 md:flex md:justify-around md:align-middle text-white container mb-12">
          ...
          <div className="flex justify-around w-full">
            ...
            <div className="flex flex-col items-center">
              <ClockIcon className="w-12 text-[#ffd700]" />
              <p className="mt-2">60 ساعت آموزش</p>
            </div>

            <div className="flex flex-col items-center">
              <PresentationChartLineIcon className="w-12 text-[#ffd700]" />
              <p className="mt-2">30 جلسه</p>
            </div>

            <div className="flex flex-col items-center">
              <AcademicCapIcon className="w-12 text-[#ffd700]" />
              <p className="mt-2">+1000 دانشجو</p>
            </div>

          </div>
        </div>

        <div className="md:w-[600px] rounded-3xl mt-8 md:mt-0">
          <video
        ...
        <div className="overflow-x-auto">
          ...
          <table className="w-full border border-gray-600 text-center">
            ...
            <thead className="bg-[#ffd700] text-black">
              ...
              <tr>
                <th className="border border-gray-600 p-3">نوع کلاس</th>
                <th className="border border-gray-600 p-3">تعداد جلسات</th>
                <th className="border border-gray-600 p-3">مدت هر جلسه</th>
              </tr>
           ...
           <tbody>
  <tr>
    <td className="border p-4">گروهی (عادی)</td>
    <td className="border p-4">30 جلسه</td>
    <td className="border p-4">2 ساعت</td>
  </tr>

  <tr>
    <td className="border p-4">گروهی (فشرده)</td>
    <td className="border p-4">15 جلسه</td>
    <td className="border p-4">3 ساعت</td>
  </tr>

  <tr>
    <td className="border p-4">نیمه خصوصی</td>
    <td className="border p-4">12 جلسه</td>
    <td className="border p-4">3 ساعت</td>
  </tr>

  <tr>
    <td className="border p-4">خصوصی</td>
    <td className="border p-4">12 جلسه</td>
    <td className="border p-4">3 ساعت</td>
  </tr>
</tbody>
