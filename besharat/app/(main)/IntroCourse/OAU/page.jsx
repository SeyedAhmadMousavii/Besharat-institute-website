  ...
  const IntroOAU = () => {
    return (
      <div className="text-[#1A1A2E] p-6 bg-white">
        ...
        <p className="leading-relaxed mb-2">دوره کاربر اتوماسیون اداری در فنی و حرفه‌ای به‌منظور آموزش مهارت‌های ضروری برای استفاده مؤثر از نرم‌افزارها و ابزارهای اداری طراحی شده است. این دوره برای افرادی که در محیط‌های کاری نیاز به کار با ابزارهای دیجیتال دارند، مناسب است و توانایی‌های شرکت‌کنندگان را در زمینه‌های مختلف تقویت می‌کند.</p>
        <p className="leading-relaxed mb-2">در این دوره، شرکت‌کنندگان با نرم‌افزارهای پرکاربرد اداری مانند Microsoft Word، Excel و PowerPoint آشنا می‌شوند. مهارت‌هایی نظیر ایجاد و ویرایش اسناد، فرمت‌بندی متن، طراحی جداول، انجام محاسبات، و ایجاد ارائه‌های حرفه‌ای از جمله مواردی هستند که به‌صورت عملی آموزش داده می‌شوند. همچنین، مدیریت اطلاعات و سازماندهی داده‌ها از طریق بانک‌های اطلاعاتی نیز به‌عنوان بخشی از آموزش‌ها ارائه می‌شود.</p>
        <p className="leading-relaxed mb-2">از دیگر مهارت‌های مورد بحث در این دوره، ارتباطات اداری است. شرکت‌کنندگان نحوه نگارش ایمیل‌های رسمی و حرفه‌ای را یاد می‌گیرند و با نرم‌افزارهای همکاری آنلاین مانند Microsoft Teams یا Zoom آشنا می‌شوند. در کنار این موارد، استفاده از ابزارهای تقویم و برنامه‌ریزی برای مدیریت زمان و افزایش بهره‌وری به آن‌ها آموزش داده می‌شود.</p>
        <p className="leading-relaxed mb-2">یکی از بخش‌های مهم دوره، آشنایی با اصول امنیت اطلاعات است. شرکت‌کنندگان یاد می‌گیرند چگونه از داده‌های خود در برابر تهدیدات محافظت کنند و به شکل امن با نرم‌افزارها کار کنند. همچنین، کار با سیستم‌های خاص اتوماسیون اداری که در سازمان‌ها استفاده می‌شود، از دیگر موضوعات این دوره است. در کنار این مهارت‌ها، شرکت‌کنندگان می‌توانند مهارت‌های عمومی نظیر کار تیمی، ارتباطات مؤثر و حل مسئله را نیز تقویت کنند.</p>
        <p className="leading-relaxed">این دوره شامل آموزش عملی، انجام پروژه‌های گروهی و ارزیابی نهایی است که باعث می‌شود شرکت‌کنندگان آماده ورود به بازار کار شوند. اگر تمایل به شرکت در این دوره دارید، می‌توانید به آموزشگاه بشارت مراجعه کنید.</p>
      </div>
    );
  };
  
  export default IntroOAU;