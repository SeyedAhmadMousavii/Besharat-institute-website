      ...
      <div className="rounded-2xl shadow-xl overflow-hidden mx-4 my-8 bg-white border border-[#E8E8F0]">
        <div className="flex flex-col-reverse md:flex-row justify-around">
          <div className="flex-1 p-6 md:p-8 text-[#1A1A2E]">
            ...
            <p className="leading-relaxed text-[#1A1A2E] font-medium">از بازارهای داخلی تا تجارت حرفه‌ای بین‌الملل</p>
            
            <p className="leading-relaxed mt-3 text-[#1A1A2E]">
              در دنیای امروز، تجارت بین‌الملل یکی از مهم‌ترین ابزارهای توسعه کسب‌وکار و دستیابی به بازارهای جهانی محسوب می‌شود. مؤسسه بین‌المللی بشارت با بهره‌گیری از اساتید مجرب و کارآزموده، محتوای آموزشی کاملاً کاربردی و رویکردی مبتنی بر استانداردهای روز دنیا، دوره تخصصی «تجارت بین‌الملل و استراتژی‌های صادرات و واردات» را با بالاترین کیفیت برگزار می‌نماید.
            </p>
            
            <p className="leading-relaxed mt-3 text-[#1A1A2E]">
              این دوره با هدف توانمندسازی فعالان اقتصادی، کارآفرینان و علاقه‌مندان به حوزه بازرگانی طراحی شده و مهارت‌های کلیدی همچون تحلیل بازارهای هدف، مدیریت فرآیندهای صادرات و واردات، مذاکرات تجاری پیشرفته، توسعه بازار و تدوین استراتژی‌های بین‌المللی را به‌صورت جامع پوشش می‌دهد. فرصت‌های بی‌نظیری در بازارهای جهانی منتظر تصمیم‌های هوشمندانه و حرفه‌ای شما هستند؛ امروز گام اول را برای ساختن آینده‌ای درخشان بردارید.
            </p>
          ...
          <div className="md:flex w-96 items-center justify-center rounded-l-2xl">
            <Image 
              src="/assets/تاجرشو.webp" 
              alt="تاجر شو - دوره تخصصی تجارت بین‌الملل" 
              width={384}
              height={300}
