    ...
    <div className="pt-10 px-4 mx-6 mb-20 -mt-10">
      ...
      <div className="relative flex justify-center">
        ...
        <div className="flex-col justify-around mt-9">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4 text-center md:text-start text-[#D4AF37] flex justify-center">
          ...
          <h2 className="text-[#1A1A2E] m-auto text-base md:text-xl text-center md:text-start mb-5">
