    ...
    <div className="pt-10 px-4 mt-6">
      <div className="flex flex-col-reverse md:flex-row gap-4 justify-between container mx-auto">
        <div className="flex-col justify-around mt-9">
          <h1 className="text-2xl md:text-2xl font-extrabold mb-4 text-center md:text-start text-white">
          آموزشگاه بین المللی کامپیوتر و ارزدیجیتال
          </h1>
          <h1 className="text-2xl md:text-5xl font-extrabold mb-4 text-center md:text-start text-[#ffd700]">
          ...
          <h1 className="text-white m-auto text-lg md:text-xl text-center md:text-start">
          ما از سال ۱۳۷۹ همراه با تجربه و تخصص از پایه نهم تا دکترا در کنار شما هستیم</h1>
