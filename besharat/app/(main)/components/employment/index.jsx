    ...
    return ( 
      ...
      <div className="flex flex-col-reverse md:flex-row-reverse gap-4 justify-between container mx-auto">
        <div className="flex-col justify-around mt-9">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-4 text-center md:text-start text-[#000080] flex justify-center">
            به خانواده بزرگ بشارت بپیوندید
          </h2>
          <h2 className="text-[#1A1A2E] m-auto text-lg md:text-xl text-center md:text-start flex justify-center mb-1 mt-6">
          با مراجعه به لینک زیر استخدام شوید.
          </h2>
          <h2 className="text-[#1A1A2E] m-auto text-lg md:text-xl text-center md:text-start mb-10 flex justify-center">
