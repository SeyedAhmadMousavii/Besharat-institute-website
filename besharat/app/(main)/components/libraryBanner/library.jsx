    ...
    <div className="pt-10 px-4 mx-6 mb-16">
      ...
      <div className="relative">
        ...
        <div className="flex-col justify-around mt-9">
          <h2 className="text-3xl font-extrabold mb-4 text-center md:text-start text-[#000080] flex justify-center">
            نمـــــونه ســـــــوالات کـــــتبی و عمـــــلی
          </h2>
          <h2 className="text-3xl font-extrabold mb-4 text-center md:text-start text-[#D4AF37] flex justify-center">
