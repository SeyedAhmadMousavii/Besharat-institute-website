  ...
  return (
    <div className="mt-10">
          ...
          <div className="flex-col justify-around align-middle">
            <div className="flex flex-col lg:flex-row justify-center items-center">
              ...
              <div className="flex-col justify-around align-middle mr-4 mt-8">
                <h2 className="text-2xl sm:text-3xl font-bold text-[#000080] text-center md:text-start">
                  آموزشگاه بشــــارت
                </h2>
                <h2 className="text-lg text-center md:text-start text-[#D4AF37]">
                  کامپیوتر | حسابداری | نقشه‌کشی | ارز دیجیتال
                </h2>
              </div>
            </div>
            <div className="md:max-w-lg w-auto p-3 md:w-full mt-5">
              <p className="text-base text-center md:text-start mb-4 md:mb-2 text-[#1A1A2E] leading-relaxed">
                آموزشگاه بین‌المللی بشارت، از سال ۱۳۷۹ به مدیریت و بنیان‌گذاری ساناز فراهانی، به‌عنوان مرجع تخصصی مهارت‌آموزی در کشور فعالیت می‌کند. این مجموعه با گذر از حوزه‌های بنیادین فناوری اطلاعات، حسابداری، نقشه‌کشی و بهره‌گیری از متدولوژی‌های نوین آموزشی، اکنون بر حوزه‌های استراتژیک هوش مصنوعی، بازارهای مالی بین‌المللی (فارکس، کریپتو، بورس) و مدیریت ارشد کسب‌وکار (DBA و MBA) تمرکز دارد.
              </p>
          ...
          <div>
            <div className="w-full py-4">
              <div className="flex flex-col gap-4">
                <h2 className="text-center font-bold text-[#000080] border-b-2 border-[#D4AF37] text-2xl pb-4"> 
                  بخش‌های سایت
                </h2>
                ...
                {links
                  ? links.map((link, i) => (
                      <a
                        key={i}
                        href={link.href}
                        className="flex gap-x-2 justify-center md:justify-start rounded-xl pr-3 md:p-1 hover:text-[#000080] cursor-pointer transition-colors"
                      >
                        {link.logo}
                        <h2 className="text-lg text-[#1A1A2E] hover:text-[#000080] transition-colors">{link.name}</h2> 
                      </a>
                    ))
                  : null}
              </div>
      ...
      <div className="block sm:hidden">
        <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-[#D4AF37] rounded-full bottom-4 left-1/2 shadow-lg overflow-hidden">
