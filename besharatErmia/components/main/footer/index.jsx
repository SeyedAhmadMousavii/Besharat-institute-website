          ...
          <div className="flex-col justify-around align-middle">
            ...
            <div className="md:max-w-lg w-auto p-3 md:w-full mt-5">
              <p className="text-base text-center md:text-start mb-4 md:mb-2 text-white">
                هدف آموزشگاه بشارت، ارائه تخصصی‌ دوره‌های آموزش کامپیوتر،
                هوش مصنوعی، نقشه‌کشی و ارزدیجیتال به علاقه‌مندان ورود به بازار
                کار است. تمامی دوره‌ها بر اساس اصول سازمان فنی و حرفه‌ای کشور
                طراحی شده‌اند و با رویکردی کاربردی و تخصصی برگزار می‌شوند. در
                این دوره‌ها، آموزش‌ها به‌صورت روان و قابل فهم ارائه می‌شود و از
                نظر محتوایی، کامل، به‌روز و متناسب با نیاز بازار کار هستند؛
                به‌طوری که هنرجو با گذراندن هر دوره، به سطح مطلوبی از مهارت و
                تخصص می‌رسد. تمامی دوره‌ها پروژه‌محور هستند تا هنرجویان مفاهیم
                را در عمل تجربه کنند و تسلط کافی به دست آورند. در کنار آموزش،
                امکان بهره‌مندی از مشاوره رایگان برای انتخاب مسیر مناسب نیز
                فراهم است. همچنین در پایان دوره، به شرکت‌کنندگان مدرک بین‌المللی
                معتبر ارائه می‌شود.
              </p>
