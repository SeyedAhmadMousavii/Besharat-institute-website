...
const IntroMBA = () => {
  return (
    <div className="text-white p-2 font-fa" dir="rtl">
      <div className="p-4 md:flex md:justify-around md:items-center container mx-auto mb-12">
        <div className="flex flex-col justify-center p-2 w-full">
          <h1 className="font-bold text-3xl mb-12 flex justify-center text-[#ffd700]">
            دوره MBA
          </h1>
          <div className="flex justify-around w-full">
            <div className="flex flex-col justify-between items-center m-auto">
              <ClockIcon className="text-[#ffd700] w-12 h-12" />
              <p className="mt-2 text-center">۵۰۰ ساعت</p>
            </div>
            <div className="flex flex-col justify-between items-center m-auto">
              <PresentationChartLineIcon className="text-[#ffd700] w-12 h-12" />
              <p className="mt-2 text-center">۲۵۰ جلسه</p>
            </div>
            <div className="flex flex-col justify-between items-center m-auto">
              <AcademicCapIcon className="text-[#ffd700] w-12 h-12" />
              <p className="mt-2 text-center">۱۰۰۰+ دانشجو</p>
            </div>
          </div>
        </div>
        <div className="md:w-[600px] w-full rounded-3xl mt-6 md:mt-0">
          <video
      ...
      <div className="container mx-auto px-4 md:px-8">
        <h2 className="text-xl md:text-2xl font-bold mt-8 text-[#ffd700]">
        ...
        <h3 className="text-lg md:text-xl font-bold mt-8 text-[#ffd700]">
      ...
      <div className="md:px-8 px-4 m-2 mt-16">
        <div className="flex items-center">
          <img
            ...
            alt="مقالات"
            className="w-20 md:w-28 -mt-10"
          />
          <h2 className="text-white font-extrabold text-3xl md:text-4xl mr-2">
            مقـــــالات
          </h2>
        </div>
        ...
        <div className="mt-10">
          <div className="flex flex-wrap justify-center md:justify-around gap-8">
            {articlesData.map((article) => (
              <div
                key={article.id}
                className="flex flex-col justify-between items-center rounded-3xl p-4 mt-10 mb-6 w-72  shadow-2xl hover:scale-105 transition-all duration-300 bg-gray-800/50"
              >
                <img
                  src={article.image}
                  alt={article.title}
                ...
                />
                <h3 className="font-bold mb-4 text-lg text-white text-center">
                  {article.title}
                </h3>
                <div className="flex justify-between items-center w-full px-2">
                  <p className="text-gray-300 text-sm">نویسنده: {article.author}</p>
                  <div className="flex items-center text-gray-300">
                    <p className="text-sm">{article.readTime}</p>
                    <ClockIcon className="text-[#ffd700] w-5 h-5 mr-1" />
                  </div>
                </div>
                <a href={article.link} className="w-full mt-4">
                  <button className="font-fa text-base rounded-full w-full bg-[#ffd700] text-black py-2 px-4 hover:bg-yellow-500 transition-colors">
                    بخوانیم!!
                  </button>
                </a>
              </div>
