    ...
    return (
        <div className="container mx-auto max-w-4xl h-[60%] w-full px-2 py-2 pb-20 flex flex-col justify-start lg:justify-center items-center">
            <div className="flex w-full pb-6">
                <Link href="/">
                    <Button variant="text" color="blue-gray" className="font-fa text-base btn-flex text-white">
            ...
            <Card className="w-full max-w-md">
                <CardHeader
                    floated={false}
                    shadow={false}
                    className="m-0 grid place-items-center rounded-b-none py-8 px-4 text-center bg-blue-900"
                >
                    <div className="mb-4 rounded-full border border-white/10 bg-white/10 p-6 text-[#E5C405]">
                        <AcademicCapIcon className="h-10 w-10" />
                    </div>
                    <Typography className="font-fa text-3xl text-[#E5C405] font-extrabold">
                        آموزشگاه بشارت
                    </Typography>
                </CardHeader>
                <CardBody>
                    <form onSubmit={formik.handleSubmit} className="mt-8 mb-2">
                        ...
                        />
                        <Button type="submit" className="font-fa text-base mt-6 bg-blue-900 text-[#E5C405]" fullWidth>
                            ورود
                        </Button>
                        <Typography color="gray" className="mt-4 text-center font-normal font-fa">
                            ...
                            <a
                                href="#"
                                className="font-medium text-blue-900 transition-colors hover:text-blue-700"
                            >
                                یکی بسازید
                            </a>
                        </Typography>
